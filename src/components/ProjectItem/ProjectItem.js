  ...
  render() {
    ...
    return (
        <div className="oneProject">
          <h3><span className='bold'>Name:</span>{project.name}</h3>
          <p><span className='bold'>Description:</span>{project.description}</p>
          <div><span className='bold'>Tags</span>{project.tags.map((tag, i) => {
